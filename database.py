...
def init_db():
    ...
    cur = conn.cursor()
    try:
        # Drop and rebuild all tables fresh
        for table in [
            "users", "songs", "beats", "drops", "announcements",
            "vault_songs", "vault_access", "fan_points", "song_likes",
            "downloads", "cart", "stripe_sessions", "payments",
            "referrals", "missions", "fan_locations", "skills",
            "bookings", "dedications", "events", "radio_history",
            "radio_queue", "radio_state",
        ]:

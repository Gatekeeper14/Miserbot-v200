...
async def handle_audio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Add a caption tag and resend:\n\n#song\n#beat\n#drop\n#announce\n#vault")
...
async def cmd_vault_unlock(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        await context.bot.send_message(fan_id, "VAULT ACCESS GRANTED\n\nGo to Secret Vault.\n\nParish 14.")
    except Exception: pass
...
async def text_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if uid in skill_sessions:
        ...
        if step == "skill_name":
            ...
            await update.message.reply_text("Great! Now describe your skill:\n\nType your description:"); return

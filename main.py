...
async def music_stream(update:Update,context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🎧 Streaming coming soon.")

async def music_support(update:Update,context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("💰 Fan support system coming soon.")

async def music_merch(update:Update,context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("👕 PARISH 14 merch store coming soon.")

async def music_share(update:Update,context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("📢 Share MiserBot with friends.")
...
async def router(update:Update,context:ContextTypes.DEFAULT_TYPE):
    ...
    if text=="🎵 Music":
        ...
        await music_stream(update,context)

    elif text=="2":
        await music_support(update,context)

    elif text=="3":
        await music_merch(update,context)

    elif text=="4":
        await music_share(update,context)

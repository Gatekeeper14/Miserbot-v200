...
def play_spaceship_entry(chat_id):
    ...
    try:
        ...
        bot.send_audio(chat_id=chat_id, audio=audio, caption="🚀 Miserbot Launch Sequence")

        name, audio = random.choice(AI_ANNOUNCEMENTS)
        bot.send_audio(chat_id=chat_id, audio=audio, caption="🤖 AI Station Online")
...
def play_random_drop(chat_id):
    ...
    try:
        ...
        bot.send_audio(chat_id=chat_id, audio=audio, caption=f"🎧 {name}")
